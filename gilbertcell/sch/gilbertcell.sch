...
S {}
E {}
N 440 -30 650 -30 { lab=#net1}
N 270 -150 610 -150 { lab=Vbias1}
N 230 -120 230 -90 { lab=#net2}
N 650 -120 650 -90 { lab=#net3}
N 140 -60 190 -60 { lab=Vrf+}
N 690 -60 720 -60 { lab=Vrf-}
N 720 -60 720 0 { lab=Vrf-}
N 140 -0 720 0 { lab=Vrf-}
N 440 -30 440 40 { lab=#net1}
N 440 110 440 120 { lab=GND}
N 230 -60 650 -60 { lab=GND}
...
N 230 -290 350 -290 { lab=#net4}
N 650 -290 740 -290 { lab=#net5}
N 230 -290 230 -180 { lab=#net4}
N 650 -290 650 -180 { lab=#net5}
N 420 -320 460 -320 { lab=Vlo+}
...
N 90 -320 350 -320 { lab=GND}
N 500 -320 740 -320 { lab=GND}
N 90 -400 90 -350 { lab=Out+}
N 740 -370 740 -350 { lab=Out-}
N 500 -400 500 -350 { lab=Out+}
N 90 -400 500 -400 { lab=Out+}
N 350 -370 350 -350 { lab=Out-}
N 350 -370 740 -370 { lab=Out-}
N 130 -510 700 -510 { lab=Vbias2}
N 230 -420 230 -290 { lab=#net4}
N 650 -420 650 -290 { lab=#net5}
N 270 -450 610 -450 { lab=Vbias3}
N 90 -620 90 -540 { lab=VDD}
N 650 -620 740 -620 { lab=VDD}
...
N 50 -420 90 -420 { lab=Out+}
N 740 -390 790 -390 { lab=Out-}
N 230 -30 440 -30 { lab=#net1}
N 440 100 440 110 { lab=GND}
N 90 -290 230 -290 { lab=#net4}
N 500 -290 650 -290 { lab=#net5}
N 390 -320 420 -320 { lab=Vlo+}
N 90 -420 90 -400 { lab=Out+}
N 740 -390 740 -370 { lab=Out-}
N 90 -620 230 -620 { lab=VDD}
N 230 -620 650 -620 { lab=VDD}
N 90 -480 90 -420 { lab=Out+}
N 740 -480 740 -390 { lab=Out-}
N 360 70 400 70 { lab=Vbias1}
...
C {devices/ipin.sym} 30 -380 0 0 {name=p1 lab=Vlo+}
C {devices/ipin.sym} 10 -320 0 0 {name=p2 lab=Vlo-}
C {devices/ipin.sym} 140 -60 0 0 {name=p3 lab=Vrf+}
C {devices/ipin.sym} 140 0 0 0 {name=p4 lab=Vrf-}
C {devices/ipin.sym} 400 -150 1 0 {name=p5 lab=Vbias1}
C {devices/ipin.sym} 440 -510 1 0 {name=p6 lab=Vbias2}
C {devices/ipin.sym} 480 -450 1 0 {name=p7 lab=Vbias3}
C {devices/opin.sym} 50 -420 0 1 {name=p8 lab=Out+}
C {devices/opin.sym} 790 -390 0 0 {name=p9 lab=Out-}
C {devices/lab_pin.sym} 360 70 0 0 {name=l1 sig_type=std_logic lab=Vbias1}
