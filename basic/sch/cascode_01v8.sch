...
S {}
E {}
N 440 -380 440 -360 { lab=#net1}
N 440 -460 440 -440 { lab=#net2}
...
N 410 -500 440 -500 { lab=#net2}
N 440 -500 440 -460 { lab=#net2}
N 410 -540 410 -500 { lab=#net2}
N 350 -570 370 -570 { lab=#net3}
...
N 290 -410 290 -400 { lab=#net4}
N 290 -410 400 -410 { lab=#net4}
N 290 -340 290 -290 { lab=GND}
N 290 -290 440 -290 { lab=GND}
N 440 -500 500 -500 {}
...
C {devices/opin.sym} 500 -500 0 0 {name=p3 lab=Out}
...
C {devices/vsource.sym} 290 -370 0 0 {name=V1 value=0.4}
